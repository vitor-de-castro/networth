...
ActiveRecord::Schema[7.1].define(version: 2026_03_09_221421) do
  ...
  create_table "assets", force: :cascade do |t|
    ...
    t.string "symbol"
    t.boolean "track_live", default: false
  ...
  create_table "net_worth_snapshots", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["user_id", "date"], name: "index_net_worth_snapshots_on_user_id_and_date", unique: true
